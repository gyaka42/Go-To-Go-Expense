...
export const transactionTypes = [
  { label: "Expense", value: "expense", labelKey: "transaction.type.expense" },
  { label: "Income", value: "income", labelKey: "transaction.type.income" },
];
